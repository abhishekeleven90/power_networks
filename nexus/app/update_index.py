...
def full_import():
	#full-import
	full_url = "http://localhost:8983/solr/mtp2/dataimport?command=full-import&clean=true&optimize=true"
...
def delete_index(index_id):
	...
	delete_url = "http://localhost:8983/solr/mtp2/update/json?wt=json"
